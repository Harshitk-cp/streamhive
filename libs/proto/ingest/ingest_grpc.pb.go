...
const (
	IngestService_IngestStream_FullMethodName = "/ingest.IngestService/IngestStream"
)
...
type IngestServiceClient interface {
	IngestStream(ctx context.Context, in *IngestRequest, opts ...grpc.CallOption) (*IngestResponse, error)
}
...
func (c *ingestServiceClient) IngestStream(ctx context.Context, in *IngestRequest, opts ...grpc.CallOption) (*IngestResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IngestResponse)
	err := c.cc.Invoke(ctx, IngestService_IngestStream_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IngestServiceServer interface {
	IngestStream(context.Context, *IngestRequest) (*IngestResponse, error)
...
func (UnimplementedIngestServiceServer) IngestStream(context.Context, *IngestRequest) (*IngestResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IngestStream not implemented")
}
...
func _IngestService_IngestStream_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IngestRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngestServiceServer).IngestStream(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestService_IngestStream_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngestServiceServer).IngestStream(ctx, req.(*IngestRequest))
	}
...
var IngestService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "IngestStream",
			Handler:    _IngestService_IngestStream_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "libs/proto/ingest/ingest.proto",
}
